...
const lessonSchema = z.object({
  ...
  // Named sample database (see src/data/sample-databases.ts) seeded into the
  // playground for every SqlPlayground/Exercise on this lesson page.
  database: z.string().optional().default('toko_buku'),
})
